    ...
    return (
      <div className="tela cadastro-produtos">
        {this.state.shouldModalAppear && (
          <Modal type="success" onClose={() => this.props.history.replace('/produtos')}>
            Produto cadastrado
          </Modal>
        )}
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="page">
            ...
            <TextBox
              ...
              onChange={this.handleChange}
            />
            <TextBox required name="brand" label="Marca" type="text" onChange={this.handleChange} />
          </div>
          ...
          <div className="page">
            ...
            <div className="item">
              <TextBox required name="qty_min" label="QTD. mínima no estoque" />
              <TextBox required name="qty_max" label="QTD. máxima no estoque" />
            </div>
            ...
            <div className="item">
              ...
              <TextBox disabled name="incl_datetime" label="Incluído em" />
            </div>

            <div className="buttons">
              <Button color="#DC2438" onClick={() => this.props.history.replace('/produtos')}>
                Cancelar
              </Button>
